...
label jang_ch1_passport_choice:
    ...
    menu:
        ...
        "여권 신청 ":  # 공백으로 구분하여 두 번째 선택지
            ...
            m "미국으로 가야 한다. 미국으로 가야 한다. 같은 소리가 머릿속에서 반복되어서 들린다."
...
label jang_ch1_scene2:
    ...
    m "이분들은 김구 선생님과 안창호 선생님? 교과서에서 봤어! 나는 독립운동가의 몸에 들어왔나 봐!"

label jang_ch1_final_choice:
    menu:
        "저는 여기가 좋아요.":
            m "내가 지금 정확히 누구 몸에 들어왔는지는 모르겠지만 이 사람이 원하는 대로 해보자"
...
label jang_ch2_gumi_choice:
    menu:
        ...
        "알겠습니다. 여기에 남아 일하겠습니다. 내일이라도 곧 떠나십시오.":
            ...
            m "독립운동을 하기 위한 돈을 모으고, 해외에 거주하고 있는 우리나라 사람에게 독립의 중요성을 알린다는 뜻이구나!"
...
label jang_ch3:
    ...
    m "구미위원부의 재정난으로 인디애나 대학으로 돌아가 다시 공부를 계속했다."
...
label jang_ch3_after_newspaper:
    ...
    # 신문 속 텍스트 표시
    show screen framed_message("1941년 12월 8일\n일본이 진주만을 기습", text_size=50)
    pause 2.0
    hide screen framed_message with dissolve
...
label jang_ch3_phone_menu:
    ...
    menu:
        ...
        "조국의 해방이 눈앞에 보이는 듯합니다. 그대로 있을 수 없어 그곳으로 바로 떠나겠습니다.":
...
label jang_ch4:
    ...
    m "어? 전에는 상해에 있었다며 이제는 충칭인가?"
    m "연락원은 무슨 일을 하는 거지?"

    window hide
    
    # 오브젝트들 등장
    show walkie_talkie with dissolve:
        xalign 0.125 yalign 0.02 zoom 0.25
    show translate_icon with dissolve:
        xalign 0.125 yalign 0.35 zoom 0.2
    show secret_doc with dissolve:
        xalign 0.112 yalign 0.60 zoom 0.2
    show old_map with dissolve:
...
label jang_ch4_liberation:
    ...
    m "지금이 대체 몇 년도 몇 월 며칠이지?"
    m "항복이라면 우리나라가 곧 독립된다는 것인가?"
